<template>
  <div class="all">
    ...
    <div class="login_box">
      <div>
        <el-input id="loginName" v-model:value="user.account" placeholder="账户"></el-input>
        <br/>
        <el-input type="password" id="loginPwd" v-model:value="user.pwd" placeholder="密码"></el-input>
        <br/>
